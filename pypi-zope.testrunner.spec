...
Version  : 7.4
Release  : 89
URL      : https://files.pythonhosted.org/packages/7d/6e/63d3b44cd79b3df454621292d7527033915ab37548c7b1d88c2237e4617c/zope_testrunner-7.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/7d/6e/63d3b44cd79b3df454621292d7527033915ab37548c7b1d88c2237e4617c/zope_testrunner-7.4.tar.gz
...
%prep
%setup -q -n zope_testrunner-7.4
cd %{_builddir}/zope_testrunner-7.4
pushd ..
cp -a zope_testrunner-7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748440416
