...
Version  : 6.6.1
Release  : 82
URL      : https://files.pythonhosted.org/packages/20/8f/f0919def2e0228aba5bfe6684b3fdbbebb88e4d5be420b76cae087dcfccc/zope_testrunner-6.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/20/8f/f0919def2e0228aba5bfe6684b3fdbbebb88e4d5be420b76cae087dcfccc/zope_testrunner-6.6.1.tar.gz
...
%prep
%setup -q -n zope_testrunner-6.6.1
cd %{_builddir}/zope_testrunner-6.6.1
pushd ..
cp -a zope_testrunner-6.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735102526
...
cp %{_builddir}/zope_testrunner-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-zope.testrunner/a0b53f43aab58b46bf79ba756c50771c605ab4c5 || :
