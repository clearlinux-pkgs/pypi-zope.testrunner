...
Version  : 7.0
Release  : 85
URL      : https://files.pythonhosted.org/packages/2e/f3/23be83aee02093fe8e78a81eaa5a3b571004b40dffa1fd381f47326551a7/zope_testrunner-7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2e/f3/23be83aee02093fe8e78a81eaa5a3b571004b40dffa1fd381f47326551a7/zope_testrunner-7.0.tar.gz
...
%prep
%setup -q -n zope_testrunner-7.0
cd %{_builddir}/zope_testrunner-7.0
pushd ..
cp -a zope_testrunner-7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739373408
