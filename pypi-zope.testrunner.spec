...
pushd ..
cp -a zope.testrunner-5.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653003080
...
cp %{_builddir}/zope.testrunner-5.4.0/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-zope.testrunner/a0b53f43aab58b46bf79ba756c50771c605ab4c5
