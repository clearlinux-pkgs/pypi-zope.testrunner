...
Version  : 6.3.1
Release  : 77
URL      : https://files.pythonhosted.org/packages/2c/0e/9efd060209dea2d6841332e92899a49b8dce74cf813fb018a460971491b3/zope.testrunner-6.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/2c/0e/9efd060209dea2d6841332e92899a49b8dce74cf813fb018a460971491b3/zope.testrunner-6.3.1.tar.gz
...
%prep
%setup -q -n zope.testrunner-6.3.1
cd %{_builddir}/zope.testrunner-6.3.1
pushd ..
cp -a zope.testrunner-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707758831
